...
**Mapit** is an app that allows the user to search for locations using the [Foursquare API](https://developer.foursquare.com/docs) and create a pin with an image annotation.
...
1.connecting apps with hardware
2. apps + bluetooth
...
<img src='https://media.giphy.com/media/1lvW570rv2qCZ5Mw26/giphy.gif' />
